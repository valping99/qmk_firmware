 ...
 * |      |      |      |      |      |      |-------.               ,-------|      | NumP |  /   |   *  |      |      |
 * |------+------+------+------+------+------|  VolU |               | ScrolU|------+------+------+------+------+------|
 * |QKBOOT|      |QWERTY|GAMING|      |      |-------.               ,-------|      | Numu | Num8 | Num9 |  -   |      |
 * |------+------+------+------+------+------|  MUTE |               | PRINT |------+------+------+------+------+------|
 * |      |      |      |      |      |MACWIN|-------.               ,-------|      | Num4 | Num5 | Num6 |  +   |      |
 * |------+------+------+------+------+------|  VolU |               | ScrolD|------+------+------+------+------+------|
 * |      |      |      |      |      |      |-------|               |-------| Num0 | Num1 | Num2 | Num3 | Enter|      |
 * `-----------------------------------------/       /                \      \-----------------------------------------'
 ...
 */
  ...
  QK_BOOT  ,XXXXXXX,KC_QWERTY,KC_GAMING,XXXXXXX,XXXXXXX,                        XXXXXXX, KC_P7,  KC_P8,   KC_P9,   KC_PMNS, XXXXXXX,
  XXXXXXX , XXXXXXX,XXXXXXX, XXXXXXX, XXXXXXX,  CG_TOGG,                        XXXXXXX, KC_P4,  KC_P5,   KC_P6,   KC_PPLS, XXXXXXX,
  XXXXXXX , XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX,_______,      _______, KC_P0,   KC_P1,  KC_P2,   KC_P3,   KC_PENT, _______,
